<?php
  ...
  $total = $mysqli->query("SELECT id FROM books");
  ...
  $result = $mysqli->query("SELECT books.*, categories.name FROM books LEFT JOIN categories ON books.category_id = categories.id ORDER BY books.created_date DESC LIMIT $start, $limit");
?>
